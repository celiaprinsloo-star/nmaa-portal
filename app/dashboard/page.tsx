...
const cardSets: Record<UserRole, DashboardCard[]> = {
  super_admin: [
    ...
    { title: "School invoices", description: "Add and track private outstanding school invoices.", href: "/admin/invoices" },
  ...
  school_owner: [
    ...
    { title: "Invoices", description: "View outstanding and paid school invoices.", href: "/school/invoices" },
    { title: "Resources", description: "View the NMAA South Africa constitution and shared documents.", href: "/resources" },
    { title: "Tournament registration", description: "Register students for upcoming tournaments.", href: "/school/tournaments" },
