        ...
        {schools.map((school) => (
          ...
          >
            ...
            <div className="school-metric-grid" style={metricGridStyle}>
              ...
              <Link className="school-metric metric-link" href={`/students?school_id=${school.id}&age_group=little_dragons`} style={metricStyle}><strong>{school.little_dragons_count ?? 0}</strong><span>Little Dragons 4-6</span></Link>
              <Link className="school-metric metric-link" href={`/students?school_id=${school.id}&age_group=karate_kids`} style={metricStyle}><strong>{school.karate_kids_count ?? 0}</strong><span>Karate Kids 7-12</span></Link>
              <Link className="school-metric metric-link" href={`/students?school_id=${school.id}&age_group=teens_adults`} style={metricStyle}><strong>{school.teens_adults_count ?? 0}</strong><span>Teens and Adults 13+</span></Link>
              <Link className="school-metric metric-link" href={`/students?school_id=${school.id}&age_group=not_grouped`} style={metricStyle}><strong>{school.age_not_grouped_count ?? 0}</strong><span>No DOB / under 4</span></Link>
