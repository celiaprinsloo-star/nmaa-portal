        ...
        {schools.map((school) => (
          ...
          >
            ...
            <div className="school-metric-grid" style={metricGridStyle}>
              ...
              <Link className="school-metric metric-link" href={`/students?school_id=${school.id}`} style={metricStyle}><strong>{school.age_not_grouped_count ?? 0}</strong><span>No DOB / under 4</span></Link>
